...
class DropDrownList : LinearLayout {
    ...
    private fun setResources() {
        ...
        context.resources.getDimension(contentPaddingRes).toInt().apply {
            recyclerView.setPadding(this, this, this, this)
        }
    }
    ...
    private fun setHeightToContentHeight(animate: Boolean) {
        measureContentRecyclerView()
        val targetHeight = panelView.height + recyclerView.measuredHeight
        if (animate) {
            animate(this, height, targetHeight, expandDuration)
        } else {
            setContentHeight(targetHeight)
    ...
    private fun measureContentRecyclerView() {
        ...
        recyclerView.measure(widthMS, heightMS)
    }
